...
class TorreController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($params_array)) {
            ...
            if ($validate->fails()) {
                ...
                $id = IdGenerator::generate(['table' => 't_torre', 'field' => 'id', 'length' => 13, 'prefix' => "Torre_"]);
    ...
    public function filterProyectoId($id)
    {
        ...
        $data = DB::select(
            ...
            'SELECT *  FROM t_torre WHERE 	id_proyecto=? ',
            [$id]
    ...
    public function filtroTorreProyecto($nombre, $proyecto)
    {   
      
        $data = DB::select(

            'SELECT *  FROM t_torre WHERE 	nombre=? AND id_proyecto=?',
            [$nombre,$proyecto]
    ...
    public function filtroProyectoTorre($proyecto)
    {   
