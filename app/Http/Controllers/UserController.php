...
class UserController extends Controller
{
     ...
     public function index()
     {
          ...
          $user = User::all()->load('Perfil_User');
     ...
     public function register(Request $request)
     {
          ...
          if (!empty($params_array)) {
               ...
               if ($validate->fails()) {
                    ...
                    $pwd = hash('sha256', $params->User_Contrasena);
                    //crear el usuario
                    $user = new User();
                    ...
                    // $user->User_Ruta_Imagen  = $params_array['User_Ruta_Imagen'];
     ...
     public function login(Request $request)
     {
         ...
         $jwtAuth = new \JwtAuth();
          ...
          if ($validate->fails()) {
               ...
               $signup = $jwtAuth->signup($params->User_Email, $pwd);
               if (!empty($params->gettoken)) {
                    $signup = $jwtAuth->signup($params->User_Email, $pwd, true);
               }
          }
     ...
     public function upload(Request $request)
     {
          ...
          if (!$image || $validate->fails()) {
               ...
               \Storage::disk('imgUsers')->put($image_name, \File::get($image));
     ...
     public function getImage($filename)
     {
          ...
          $isset = \Storage::disk('imgUsers')->exists($filename);

          if ($isset) {

               $file = \Storage::disk('imgUsers')->get($filename);
